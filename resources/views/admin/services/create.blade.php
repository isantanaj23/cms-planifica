...
<head>
    ...
    <title>Crear Servicio - Planifica+ CMS</title>
        ...
        <div class="content-area">
            <div class="content-card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1">Crear Nuevo Servicio</h4>
                        <p class="text-muted mb-0">Agrega un nuevo servicio a Planifica+</p>
                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('order') }}" 
                                           min="0">
                                    <div class="form-text">Déjalo vacío para asignar automáticamente</div>
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="icon-preview" id="iconPreview">
                                    <i class="fas fa-cog" id="previewIcon"></i>
                                </div>
                            </div>
                            <div class="col-md-9">
                                ...
                                <div class="icon-grid">
                                    ...
                                    <div class="icon-option selected" data-icon="fas fa-cog">
                                        <i class="fas fa-cog"></i>
                                    </div>
                                    ...
                                    <div class="icon-option" data-icon="fas fa-search">
                                    ...
                                    <div class="icon-option" data-icon="fas fa-globe-americas">
